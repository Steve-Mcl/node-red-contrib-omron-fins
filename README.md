...
* FINS works with PLC Addresses.  NJ and NX PLCs do NOT have regular addresses like DM or E0_, E1_. 
   * In order to communicate via FINS on NJ/NX PLCs, for you must create a Global TAG that creates virutal data area for FINS access. E.G. If you want to read and write 40 WDs from E0_9000 ~ E0_9039 then you need to add a TAG like this  `TAG_NAME      ARRAY[0..39] Of WORD        %E0_9000`
   ![image](https://user-images.githubusercontent.com/44235289/85562713-a619ad80-b624-11ea-971b-dc22754d7cf1.png)
   

## Data formats and conversion

NOTE: This node returns 16bit signed or unsigned data only.  While that may seen restrictive it was a deliberate design decision to keep the node mean and lean. 
...
This node "node-red-contrib-buffer-parser" https://flows.nodered.org/node/node-red-contrib-buffer-parser is capable of pretty much anything you will need for this or any PLC that returns 16 nit data or a buffer (like the modbus nodes).
